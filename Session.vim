...
set iminsert=0
set imsearch=0
set makeprg=/usr/local/godi/bin/omake\ --output-only-errors
set mouse=a
...
set shortmess=aoO
badd +59 clib/osymbols.h
badd +92 olib/ofltk.ml
badd +150 clib/osymbols.cpp
badd +25 boxdemo.ml
badd +82 clib/owidget.cpp
badd +53 clib/owidget.h
badd +65 clib/obox.cpp
badd +34 clib/ocamlfltk.h
badd +5 olib/box.ml
badd +10 olib/box.mli
badd +4 olib/ask.mli
badd +8 olib/ask.ml
badd +31 olib/symbols.ml
badd +8 olib/symbols.mli
silent! argdel *
edit boxdemo.ml
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 23 - ((0 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
