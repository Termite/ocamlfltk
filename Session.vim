...
set shortmess=aoO
badd +114 clib/osymbols.h
badd +261 olib/ofltk.ml
badd +53 clib/osymbols.cpp
badd +41 boxdemo.ml
badd +129 clib/owidget.cpp
badd +72 clib/owidget.h
...
badd +4 olib/ask.mli
badd +8 olib/ask.ml
badd +110 olib/symbols.ml
badd +8 olib/symbols.mli
badd +57 clib/omultiimage.h
badd +1 clib/multiimage.h
badd +14 clib/omultiimage.cpp
badd +33 clib/OMakefile
badd +1 clib/obutton.cpp
badd +45 clib/ostatusbar.cpp
badd +37 clib/oxpmimage.h
badd +1 clib/xpmimage.h
badd +9 clib/oimage.h
badd +31 clib/oimage.cpp
badd +14 clib/oxpmimage.cpp
silent! argdel *
edit clib/oimage.cpp
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((16 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 110 - ((33 * winheight(0) + 20) / 41)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
